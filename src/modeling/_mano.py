...
class MANO(nn.Module):
    ...
    def get_layer(self):
        return ManoLayer(mano_root=osp.join(self.mano_dir), flat_hand_mean=False, use_pca=False, joint_rot_mode='rotmat', root_rot_mode='rotmat') # load right hand MANO model
